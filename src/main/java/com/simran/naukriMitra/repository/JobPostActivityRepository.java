...
public interface JobPostActivityRepository extends JpaRepository<JobPostActivity, Integer> {
	...
	//Query to retrieves list of job for a given recruiter id, also includes a count of candidates who applied foe a given job
	//So long Query bcoz of combining data from multiple tables
